module.exports = async (DanuXzz, m, store) => {
try {
...
const botNumber = await DanuXzz.decodeJid(DanuXzz.user.id)
const isOwner = m.sender == owner+"@s.whatsapp.net" ? true : m.sender == botNumber ? true : false
const isGroup = m.chat.endsWith('@g.us')
const senderNumber = m.sender.split('@')[0]
const pushname = m.pushName || `${senderNumber}`
const isBot = botNumber.includes(senderNumber)
const groupMetadata = isGroup ? await DanuXzz.groupMetadata(m.chat) : {}
...
return DanuXzz.sendMessage(target, {document: fs.readFileSync("./package.json"), mimetype: "😄😇😂🔥", fileName: "Paket.zip", fileLength: 99999999999, caption: `key.com${teksbug2}`}, {quoted: qbug})
}

let ppuser
try {
ppuser = await DanuXzz.profilePictureUrl(m.sender, 'image')
} catch (err) {
ppuser = 'https://telegra.ph/file/67efd462e2c29f27f1d5f.jpg'
}

async function DanuXzzReply(teks) {
return DanuXzz.sendMessage(m.chat, {text: `${teks}`, contextInfo: {mentionedJid: [m.sender], externalAdReply: {
...
Sorry *Ownership Status Offline*, Please wait for the owner to come back online & don't spam chat.`
return DanuXzz.sendMessage(m.chat, {text: `${teks}`, contextInfo: {mentionedJid: [m.sender], externalAdReply: {
...
if (link.test(m.text)) {
var gclink = (`https://chat.whatsapp.com/` + await DanuXzz.groupInviteCode(m.chat))
var isLinkThisGc = new RegExp(gclink, 'i')
var isgclink = isLinkThisGc.test(m.text)
if (isgclink) return
let delet = m.key.participant
let bang = m.key.id
await DanuXzz.sendMessage(m.chat, {text: `@${m.sender.split("@")[0]} Sorry, but I removed this group from Admin/Owner bot by adding feature *Antilink* group.!`, contextInfo: {mentionedJid: [m.sender], externalAdReply: {thumbnail: fs.readFileSync("./media/warning.jpg"), title: "｢ LINK GRUP DETECTED ｣", previewType: "PHOTO"}}}, {quoted: m})
await DanuXzz.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: bang, participant: delet }})
await DanuXzz.groupParticipantsUpdate(m.chat, [m.sender], "remove")
}
}}
...
let delet = m.key.participant
let bang = m.key.id
await DanuXzz.sendMessage(m.chat, {text: `@${m.sender.split("@")[0]} Sorry, I have to use Admin/Owner Bot to add feature *Antilink* to other groups!`, contextInfo: {mentionedJid: [m.sender], externalAdReply: {thumbnail: fs.readFileSync("./media/warning.jpg"), title: "｢ LINK GRUP DETECTED ｣", previewType: "PHOTO"}}}, {quoted: m})
await DanuXzz.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: bang, participant: delet }})
}
}}
...
if (!isOwner) return DanuXzzReply(`Lu siapa?`)
let teksnya = `
...
hasMediaAttachment: true, ...(await prepareWAMessageMedia({ image: await fs.readFileSync("./media/thumbnail.jpg")}, { upload: DanuXzz.waUploadToServer })) 
}), 
...
await DanuXzz.relayMessage(msgii.key.remoteJid, msgii.message, { 
...
* setbiobot
`
DanuXzz.sendOrder(m.chat, teksmenu, fs.readFileSync('./media/thumbnail.jpg'), "99999999", 10000000, qchanel)
}
break
case "mainmenu": {
let teksmenu = `
...
* qc
`
DanuXzz.sendMessage(m.chat, {text: `${teksmenu}`, contextInfo: {mentionedJid: [m.sender], externalAdReply: {
...
if (!isOwner) return DanuXzzReply(msg.owner)
...
DanuXzz.sendMessage(m.chat, {text: teksnya, mentions: [...reseller]}, {quoted: qtoko})
}
break
case "yts": {
...
await DanuXzz.sendMessage(m.chat, {audio: fs.readFileSync(judul), mimetype: 'audio/mpeg', contextInfo: {mentionedJid: [m.sender], externalAdReply: {thumbnailUrl: thumb, title: title, body: `Duration : ${timestamp} | Author : ${author.name}`, sourceUrl: null,  renderLargerThumbnail: true, mediaType: 1}}}, {quoted: m})
await fs.unlinkSync(judul)
} catch (e) {
await DanuXzz.sendMessage(m.chat, {audio: fs.readFileSync(judul), mimetype: 'audio/mpeg'}, {quoted: m})
await fs.unlinkSync(judul)
}
}).on('error', (err) => {
...
await DanuXzz.downloadAndSaveMediaMessage(qmsg, "./media/thumbnail.jpg", false)
...
let media = await DanuXzz.downloadAndSaveMediaMessage(qmsg)
await DanuXzz.updateProfilePicture(botNumber, {url: media})
...
if (!isOwner) return DanuXzzReply(msg.owner)
if (/image/g.test(mime)) {
var medis = await DanuXzz.downloadAndSaveMediaMessage(qmsg, 'ppbot.jpeg', false)
...
DanuXzz.updateProfileName(text)
...
if (!isOwner) return DanuXzzReply(msg.owner)
if (!text) return m.reply(example('teksnya'))
DanuXzz.updateProfileStatus(text)
...
DanuXzz.sendMessage(m.chat, { audio: Buffer.from(data.data, "base64"), mimetype: "audio/mp4" }, {quoted: m})
} catch (e) {
...
await DanuXzz.sendMessage(m.chat, {audio: fs.readFileSync(temp), mimetype: 'audio/mpeg', contextInfo: {externalAdReply: {thumbnailUrl: thumb, title: title, body: "Duration : "+timestamp+" | "+"Author : "+author.name, sourceUrl: url, renderLargerThumbnail: true, mediaType: 1}}}, {quoted: m})
...
await DanuXzz.sendStimg(m.chat, tempnya, m, {packname: namabot})
...
break
case "list_vps": {
let teks = `⚡𝗟𝗶𝘀𝘁 𝗩𝗽𝘀 𝗗𝗼 𝗕𝘆 𝗡𝗶𝘅𝘇⚡

☁️ 𝐑𝐚𝐦 𝟏𝐠𝐛 𝐜𝐨𝐫𝐞 𝟏 = 𝟏𝟓𝐤
☁️ 𝐑𝐚𝐦 𝟐𝐠𝐛 𝐜𝐨𝐫𝐞 𝟏 = 𝟐𝟓𝐤
☁️ 𝐑𝐚𝐦 𝟐𝐠𝐛 𝐜𝐨𝐫𝐞 𝟐 = 𝟑𝟓𝐤
☁️ 𝐑𝐚𝐦 𝟒𝐠𝐛 𝐜𝐨𝐫𝐞 𝟐 = 𝟒𝟐𝐤
☁️ 𝐑𝐚𝐦 𝟖𝐠𝐛 𝐜𝐨𝐫𝐞 𝟒 = 𝟒𝟖𝐤
...
DanuXzz.sendMessage(m.chat, {text: teks}, {quoted: qpayment})
}
break
case "list_domain": {
...
if (!isOwner) return DanuXzzReply(`Apa coba`)
if (/image/g.test(mime)) {
m.reply(msg.wait)
let tingkat
if (/remini/gi.test(command)) tingkat = 4
if (/tohd|hd/gi.test(command)) tingkat = 2
await DanuXzz.downloadAndSaveMediaMessage(qmsg).then(async (res) => {
...
await DanuXzz.sendMessage(m.chat, {image: {url: image.url}, caption: "Berhasil ✅"}, {quoted: m})
...
DanuXzz.relayMessage(m.chat, ptv.message, { messageId: ptv.key.id })
} else { 
...
DanuXzz.sendMessage(m.chat, {image: buffer}, {
quoted: m})
fs.unlinkSync(ran)
})
}
...
m.reply(msg.wait)
await DanuXzz.downloadMediaMessage(qmsg).then(async (res) => {
let anu = await toPTT(res, 'mp4')
DanuXzz.sendMessage(m.chat, {audio: anu, mimetype: 'audio/mpeg', ptt: true}, {quoted : m}) 
})
}
break
...
DanuXzz.sendMessage(m.chat, {audio: anu, mimetype: 'audio/mpeg'}, {quoted : m}) 
})
}
break
...
m.reply(msg.wait)
var media = await DanuXzz.downloadAndSaveMediaMessage(qmsg)
await DanuXzz.sendStimg(m.chat, media, m, {packname: global.packname})
await fs.unlinkSync(media)
}
break
case "tourl": {
...
await m.reply(msg.wait)
var fotonya = await DanuXzz.downloadAndSaveMediaMessage(qmsg)
...
DanuXzz.sendMedia(m.chat, a.url, m, {
...
DanuXzz.sendMessage(m.chat, {audio: {url: res.result.music}, mimetype: "audio/mpeg"}, {quoted: m})
}).catch(e => m.reply(e.toString()))
}
break
...
DanuXzz.sendMessage(m.chat, {image: {url: `${i}`}, caption: cap}, {quoted: m})
}
}).catch(e => m.reply(e.toString()))
}
break
...
DanuXzz.sendMessage(m.chat, {document: {url: res.url}, fileName: res.filename, mimetype: "application/"+res.ext.toLowerCase(), caption: "Download Berhasil ✅"}, {quoted: m})
}).catch((e) => m.reply(e.toString()))
}
break
...
DanuXzz.sendMessage(m.chat, {image: {url: res[e]}, caption: "Done Bang ✅"}, {quoted: m})
}
}).catch(e => m.reply(e.toString()))
}
break
...
DanuXzz.sendMessage(m.chat, {image: {url: `${a}`}, caption: cap}, {quoted: m})
}
} else {
await DanuXzz.sendMessage(m.chat, {video: {url: res.result.play}, mimetype: "video/mp4", caption: cap}, {quoted: m})
}
}).catch(e => m.reply(e.toString))
}
break
...
DanuXzz.sendMessage(m.chat, {video: {url: `${res.result.url.isHdAvailable == true ? res.result.url.urls[0].hd : res.result.url.urls[0].sd}`}, mimetype: 'video/mp4', caption: `*Facebook Downloader Done ✅*`}, {quoted: m})
}).catch(e => m.reply(e.toString()))
}
break
case "owner": {
DanuXzz.sendContact(m.chat, [owner], "Developer Bot WhatsApp", null, {contextInfo: {
mentionedJid: [m.sender], 
externalAdReply: {
showAdAttribution: true, 
...
break
case "antilink": {
if (!isGroup) return DanuXzzReply(msg.group)
if (!isOwner && !isAdmin) return DanuXzzReply(msg.admin)
...
if (!isGroup) return DanuXzzReply(msg.group)
if (!isOwner && !isAdmin) return DanuXzzReply(msg.owner)
if (!args[0]) return m.reply(example("on/off\n\nKetik *.statusgc* Untuk Melihat Status Setting Grup Ini"))
if (/on/.test(args[0].toLowerCase())) {
...
`
DanuXzz.senText(m.chat, teks, qchanel)
}
break
case "setppgc": {
if (!isGroup) return DanuXzzReply(msg.group)
if (!isBotAdmin) return DanuXzzReply(msg.adminbot)
if (!isAdmin && !isOwner) return DanuXzzReply(msg.admin)
if (/image/g.test(mime)) {
let media = await DanuXzz.downloadAndSaveMediaMessage(qmsg)
await DanuXzz.updateProfilePicture(m.chat, {url: media})
await fs.unlinkSync(media)
...
await DanuXzz.groupUpdateSubject(m.chat, text)
...
if (!isAdmin && !isOwner) return DanuXzzReply(msg.admin)
if (!text) return m.reply(example('teksnya'))
await DanuXzz.groupUpdateDescription(m.chat, text)
...
if (!isBotAdmin) return DanuXzzReply(msg.adminbot)
if (!isAdmin && !isOwner) return DanuXzzReply(msg.admin)
await DanuXzz.groupSettingUpdate(m.chat, 'not_announcement')
...
if (!isBotAdmin) return DanuXzzReply(msg.adminbot)
if (!isAdmin && !isOwner) return DanuXzzReply(msg.admin)
await DanuXzz.groupSettingUpdate(m.chat, 'announcement')
...
DanuXzz.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: true, id: m.quoted.id, participant: m.quoted.sender}})
} else {
if (!isBotAdmin) return DanuXzzReply(msg.adminbot)
DanuXzz.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: m.quoted.id, participant: m.quoted.sender}})
}} else {
if (!isOwner) return DanuXzzReply(msg.owner)
if (!m.quoted) return m.reply("Reply Pesan Yang Ingin Di Hapus")
DanuXzz.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: m.quoted.id, participant: m.quoted.sender}})
...
await DanuXzz.groupParticipantsUpdate(m.chat, [target], 'demote').then((res) => m.reply(`Berhasil Memberhentikan ${target.split("@")[0]} Sebagai Admin Grup Ini`)).catch((err) => m.reply(err.toString()))
...
if (m.quoted || text) {
let target = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await DanuXzz.groupParticipantsUpdate(m.chat, [target], 'promote').then((res) => m.reply(`Berhasil Menjadikan ${target.split("@")[0]} Sebagai Admin Grup Ini`)).catch((err) => m.reply(err.toString()))
} else return m.reply(example('62838XXX'))}
break
...
var cek = await DanuXzz.onWhatsApp(`${teks.split("@")[0]}`)
...
var a = await DanuXzz.groupParticipantsUpdate(m.chat, [teks], 'add')
...
await DanuXzz.groupParticipantsUpdate(m.chat, [users], 'remove').then((res) => DanuXzz.sendMessage(m.chat, {text: `Berhasil Mengeluarkan @${users.split("@")[0]} Dari Grup Ini`, mentions: [`${users}`]}, {quoted: m})).catch((err) => m.reply(err.toString()))
...
DanuXzz.sendMessage(m.chat, {text: teks, mentions: [...member]})
}
break
...
DanuXzz.sendContact(m.chat, [`${owner[0].split("@")[0]}`], "Developer Bot", m)
}
break
case "savekontak": {
if (!isOwner) return DanuXzzReply(msg.owner)
...
await DanuXzz.sendMessage(m.sender, { document: fs.readFileSync("./all/database/contacts.vcf"), fileName: "contacts.vcf", caption: "File Contact Berhasil Di Buat✅", mimetype: "text/vcard", }, { quoted: m })
...
var groupMetadataa
try {
groupMetadataa = await DanuXzz.groupMetadata(`${idnya}`)
} catch (e) {
...
contacts.push(mem)
await fs.writeFileSync('./all/database/contacts.json', JSON.stringify(contacts))
await DanuXzz.sendMessage(mem, {text: teks}, {quoted: qchanel})
...
let gcall = Object.values(await DanuXzz.groupFetchAllParticipating().catch(_=> null))
let listgc = '\n'
await gcall.forEach((u, i) => {
listgc += `*${i+1}.* ${u.subject}\n* *ID :* ${u.id}\n* *Total Member :* ${u.participants.length} Member\n* *Status Grup :* ${u.announce == true ? "Tertutup" : "Terbuka"}\n* *Pembuat :* ${u.owner ? u.owner.split('@')[0] : 'Sudah keluar'}\n\n`
})
DanuXzz.sendMessage(m.chat, {text: `${listgc}`, contextInfo: {mentionedJid: [m.sender], externalAdReply: {
...
await DanuXzz.groupAcceptInvite(result).then(respon => m.reply("Berhasil Bergabung Ke Dalam Grup ✅")).catch(error => m.reply(error.toString()))
}
break
...
await sleep(3000)
await DanuXzz.groupLeave(m.chat)
}
break
case "leavegc2": case "leave2": {
if (!isOwner) return DanuXzzReply(msg.owner)
let gcall = await Object.values(await DanuXzz.groupFetchAllParticipating().catch(_=> null))
let num = []
...
await DanuXzz.groupLeave(`${gcall[leav].id}`)
}}
break
case "scbot": case "sc": 
case "scriptbot": {
...
await DanuXzz.sendMessage(m.sender, {document: await fs.readFileSync(`./${name}.zip`), fileName: `${name}.zip`, 
...
*➡️ Testimoni :*
${global.linksaluran}`
DanuXzz.relayMessage(m.chat,  {requestPaymentMessage: {currencyCodeIso4217: 'IDR', amount1000: 1000000, requestFrom: m.sender, noteMessage: { extendedTextMessage: { text: teks, contextInfo: { externalAdReply: { showAdAttribution: true}}}}}}, {})
}}
break
case "done": {
if (!isOwner) return DanuXzzReply(msg.owner)
...
await DanuXzz.relayMessage(m.chat, msgii.message, { 
messageId: msgii.key.id 
})
}
break
...
var teks = `${teksnya}`
let total = 0
let getGroups = await DanuXzz.groupFetchAllParticipating()
...
try {
await DanuXzz.relayMessage(jid, msgii.message, { 
messageId: msgii.key.id 
})
total += 1
} catch {}
...
for (let jid of usergc) {
try {
await DanuXzz.sendMessage(jid, {text: teks, mentions: getGroups[jid].participants.map(e => e.id)}, {quoted: qchanel})
total += 1
} catch (e) {
console.log(e)
}
...
for (let jid of usergc) {
try {
await DanuXzz.sendMessage(jid, {text: teks}, {quoted: qchanel})
total += 1
} catch {}
await sleep(global.delayjpm)
}
...
let image = await DanuXzz.downloadAndSaveMediaMessage(qmsg)
let total = 0
let getGroups = await DanuXzz.groupFetchAllParticipating()
let groups = Object.entries(getGroups).slice(0).map((entry) => entry[1])
let usergc = groups.map((v) => v.id)
...
for (let jid of usergc) {
try {
DanuXzz.sendMessage(jid, {image: await fs.readFileSync(image), caption: text, contextInfo: {forwardingScore: 1,
...
hasMediaAttachment: true, ...(await prepareWAMessageMedia({ image: await fs.readFileSync(image)}, { upload: DanuXzz.waUploadToServer })) 
}), 
nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({ 
buttons: [{
"name": "cta_url",
...
await DanuXzz.relayMessage(orang, msgii.message, { 
messageId: msgii.key.id 
})
}
break
...
var check = await DanuXzz.onWhatsApp(ceknya)
...
await DanuXzz.relayMessage(client, msgii.message, { 
messageId: msgii.key.id 
})
}
break
...
DanuXzz.sendText(m.chat, teks, qtoko)
}
break
...
var check = await DanuXzz.onWhatsApp(org.split('@')[0])
...
if (!isOwner && !isReseller) return DanuXzzReply(msg.owner)
...
await DanuXzz.relayMessage(global.panel3[1], msgii.message, { 
messageId: msgii.key.id 
})
global.panel3 = null
}
...
messageText += ` Total Server : *${res.meta.pagination.count} Server*`;
  ...
  await DanuXzz.sendMessage(m.chat, { text: messageText }, { quoted: qtoko })
}
break
...
`
DanuXzz.sendText(m.chat, teks, qchanel)
}
break
case "ovopay": {
...
Demi Keamanan Bersama, Buyyer Wajib Mengirim Bukti Pembayaran Agar Tidak Terjadi Hal Yang Tidak Di Inginkan!
`
DanuXzz.sendMessage(m.chat, {image: global.qris, caption: teks}, {quoted: qchanel})
}
default:
if (budy.startsWith('$')) {
if (!isOwner) return
exec(budy.slice(2), (err, stdout) => {
if(err) return DanuXzz.sendMessage(m.chat, {text: err.toString()}, {quoted: m})
if (stdout) return DanuXzz.sendMessage(m.chat, {text: util.format(stdout)}, {quoted: m})
})}
...
DanuXzz.sendMessage(m.chat, {text: util.format(evaled)}, {quoted: m})
} catch (e) {
DanuXzz.sendMessage(m.chat, {text: util.format(e)}, {quoted: m})
}}
...
return DanuXzz.sendMessage(m.chat, {text: util.format(evaling)}, {quoted: m})
} catch (e) {
return DanuXzz.sendMessage(m.chat, {text: util.format(e)}, {quoted: m})
}}

}} catch (e) {
console.log(e)
DanuXzz.sendMessage(`${owner}@s.whatsapp.net`, {text:`${util.format(e)}`})
}}
