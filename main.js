...
let teksnotif = `Berhasil Tersambung Ke Nomor WhatsApp ${Skyzo.user.id.split(":")[0]}`
Skyzo.sendMessage("621112223334@s.whatsapp.net", {text: teksnotif})
